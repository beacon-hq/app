            ...
            <TooltipProvider>
                <Tooltip>
                    ...
                    <TooltipContent side="right" className="bg-neutral-600 text-md">
                        Toggle Sidebar
                        <kbd className="pointer-events-none inline-flex select-none items-center h-full rounded-sm border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100 ml-2">
