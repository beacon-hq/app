...
>(({ className, ...props }, ref) => (
    <div className="flex items-center border-b p-2" cmdk-input-wrapper="">
        ...
        <CommandPrimitive.Input
            ref={ref}
            className={cn(
                'placeholder:text-muted-foreground flex h-10 w-full rounded-md bg-transparent py-3 pl-8 text-sm outline-none disabled:cursor-not-allowed disabled:opacity-50',
                className,
            )}
            {...props}
        />
