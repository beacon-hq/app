        ...
        const content = (
            ...
            >
                ...
                <div className="flex flex-col justify-start pt-1">
                    <TimelineTime className="text-right pr-4 whitespace-nowrap">{date}</TimelineTime>
                </div>
...
const TimelineIcon = ({
    ...
    icon?: React.ReactNode;
    color?: 'primary' | 'secondary' | 'muted' | 'accent' | 'destructive' | Color;
    ...
    const bgColor = !['primary', 'secondary', 'muted', 'accent', 'destructive'].includes(color)
        ? `bg-${color}-400`
        : '';
