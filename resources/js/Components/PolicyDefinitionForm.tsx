            ...
            <div className="border p-2 flex flex-col gap-4">
                <HoverCard>
                    ...
                    <HoverCardContent className="prose">
                        ...
                        <p>
                            Context properties are used to define which value from the Pennant context to match against
                            when evaluating the policy. You can use dot-notation to access nested properties and array
                            keys (e.g. <code>user.id</code>).
                        </p>
                    </HoverCardContent>
                </HoverCard>
                                        ...
                                        <div className="w-1/3">
                                            <PolicyValueEditor
                                                ...
                                                allowMultiple={
                                                    !definition.operator
                                                        ? false
                                                        : !singleValueOperators.includes(
                                                              definition.operator as PolicyDefinitionMatchOperator,
                                                          )
                                                }
