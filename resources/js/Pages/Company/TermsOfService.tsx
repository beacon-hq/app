        ...
        <GuestLayout>
            ...
            <section className="prose dark:prose-invert">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            <a href="https://beacon-hq.app" rel="external nofollow noopener" target="_blank">
                                https://beacon-hq.app
                            </a>
                        </p>
                    </li>
                ...
                <p>
                    ...
                    the Company. You will not receive a refund for the fees You already paid for Your current
                    Subscription period and You will be able to access the Service until the end of Your current
                    Subscription period.
                </p>
                <h3>Billing</h3>
                <p>
                ...
                <p>
                    ...
                    You canceled Your Subscription, You will be automatically charged the applicable Subscription fees
                ...
                <ul>
                    <li>By email: tos@beacon-hq.dev</li>
                </ul>
            </section>
        </GuestLayout>
    );
