        ...
        <GuestLayout>
            ...
            <section className="prose dark:prose-invert">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Business</strong>, for the purpose of CCPA/CPRA, refers to the Company as the legal
                            entity that collects Consumers' personal information and determines the purposes and means
                            of the processing of Consumers' personal information, or on behalf of which such information
                            is collected and that alone, or jointly with others, determines the purposes and means of
                            the processing of consumers' personal information, that does business in the State of
                            California.
                        </p>
                    </li>
                    <li>
                        <p>
                            <strong>CCPA</strong> and/or <strong>CPRA</strong> refers to the California Consumer Privacy
                            Act (the &quot;CCPA&quot;) as amended by the California Privacy Rights Act of 2020 (the
                            &quot;CPRA&quot;).
                        </p>
                    </li>
                    <li>
                        <p>
                            ...
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Beacon HQ.
                        </p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Beacon HQ, accessible from{' '}
                            <a href="https://beacon-hq.dev" rel="external nofollow noopener" target="_blank">
                                https://beacon-hq.dev
                            </a>
                        </p>
                    </li>
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p>
                            ...
                            information, medical information, or health insurance information. Some personal information
                ...
                <ul>
                    ...
                    <li>
                        <strong>From Service Providers</strong>. For example, third-party vendors for payment
                ...
                <ul>
                    ...
                    <li>
                        <strong>The right to know/access.</strong> Under CCPA/CPRA, You have the right to request that
                    ...
                    <li>
                        <strong>The right to say no to the sale or sharing of Personal Data (opt-out).</strong> You have
                    ...
                    <li>
                        <strong>The right to correct Personal Data.</strong> You have the right to correct or rectify
                        ...
                        Providers to correct) Your personal information, unless an exception applies.
                    </li>
                    <li>
                        <strong>The right to limit use and disclosure of sensitive Personal Data.</strong> You have the
                ...
                <p>
                    ...
                    and limit the use of sensitive information collected.
                </p>
                <p>
                ...
                <ul>
                    <li>By email: privacy@beacon-hq.dev</li>
                </ul>
                <p>
                ...
                <p>
                    ...
                    an additional 45 days when reasonably necessary and with prior notice.
                </p>
                <p>
                ...
                <p>
                    ...
                    goods reasonably expected by an average consumer who requests such services or goods.
                </p>
                <p>
                    ...
                    of Your Personal Data&quot; section or contact us.
                </p>
                <h2>
